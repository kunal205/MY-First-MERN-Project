            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item align-self-end mx-md-auto">
                <NavLink className="nav-link " aria-current="page" to="/">
                  ...
                  <IoIosHome className="d-none d-lg-block fs-4" />
                </NavLink>
              </li>
              <li className="nav-item  align-self-end mx-md-auto">
                <NavLink className="nav-link" to="/Admin">
                  <span className="d-lg-none"> Admin</span>
                  <MdOutlineAdminPanelSettings className="d-none d-lg-block fs-4" />
                </NavLink>
              </li>
              <li className="nav-item  align-self-end mx-md-auto">
                <NavLink className="nav-link" to="/wishlist">
                  <span className="d-lg-none"> WishList</span>
                  <FaRegHeart className="d-none d-lg-block fs-4" />
                </NavLink>
              </li>
              <li className="nav-item  align-self-end mx-md-auto">
                <NavLink className="nav-link" to="/addtocart">
                  <span className="d-lg-none">Cart</span>
                  <TiShoppingCart className="d-none d-lg-block fs-4" />
                </NavLink>
              </li>
            </ul>
          </div>
